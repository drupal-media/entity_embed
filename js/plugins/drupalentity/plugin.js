  ...
  CKEDITOR.plugins.add('drupalentity', {
    ...
    beforeInit: function (editor) {
      ...
      editor.addCommand('editdrupalentity', {
        ...
        requiredContent: 'drupal-entity[data-embed-button,data-entity-type,data-entity-id,data-entity-uuid,data-entity-embed-display,data-entity-embed-settings]',
        modes: { wysiwyg : 1 },
        canUndo: true,
      ...
      if (editor.ui.addButton) {
        for (var key in editor.config.DrupalEntity_buttons) {
          ...
          editor.ui.addButton(button.id, {
            label: button.label,
            data: button,
            allowedContent: 'drupal-entity[!data-embed-button,!data-entity-id,!data-entity-uuid,!data-entity-embed-display,!data-entity-embed-settings]',
