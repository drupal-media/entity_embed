...
/**
 * Provides an Entity Embed widget plugin manager.
 *
 * @see \Drupal\entity_embed\Annotation\EntityEmbedWidget
 * @see \Drupal\entity_embed\EntityEmbedWidget\EntityEmbedWidgetInterface
 */
class EntityEmbedWidgetManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/EntityEmbed/Widget', $namespaces, $module_handler, 'Drupal\entity_embed\EntityEmbedDisplay\EntityEmbedDisplayInterface', 'Drupal\entity_embed\Annotation\EntityEmbedDisplay');
